...
const experiencesContent = `Technical Skills:
--- 
  ...
  return (
    <div className="my-5">
      <div className="d-grid gap-2 d-md-block">
        <button
          type="button"
          className="mx-3 btn btn-dark btn-lg col-2"
          onClick={linkOpen}
        >
          JS Projects
        </button>
          ...
          <div className="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <h3 className="h1 modal-title">Experiences</h3>
                <button
                  type="button"
                  className="btn-close"
                  aria-label="Close"
              ...
              <div className="h6 modal-body text-start">
                <ReactMarkdown>{experiencesContent}</ReactMarkdown>
              </div>
            </div>
          </div>
        </div>
